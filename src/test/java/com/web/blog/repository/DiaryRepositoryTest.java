...
public class DiaryRepositoryTest  {
	...
	final static Diary table = new Diary(id, false, false, false, false, false, false, false, false, new Date(), false);
    ...
    public void whenDeletingJoke_thenNotAvailableOnRetrievalEntityJokes() {
        ...
        assertNotEquals(diary.orElse(new Diary()), table); 
    }
    ...
    public void whenSavingAndDeletingJoke_thenNotAvailableOnRetrievalEntityJokes() {
       	...
       	Optional<Diary> diary = repository.findById(id);
       	Diary uid = diary.orElse(new Diary());
    ...
    public void whenUpdatingJoke_thenAvailableOnRetrievalEntityJokes() {
    	...
    	table.setGerman(true);
    	
       	repository.save(table);
       	 
       	Optional<Diary> diaryOpt = repository.findById(id);
       	Diary diary = diaryOpt.orElse(new Diary());

        assertEquals(diary.isGerman() , table.isGerman() ); 
